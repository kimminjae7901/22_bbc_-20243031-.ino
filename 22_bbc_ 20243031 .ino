...
#define _DUTY_MAX 1800 // 1880
#define _DUTY_NEU 1600 // 1640
#define _DUTY_MIN 900 // 950

#define _SERVO_ANGLE_DIFF  70  // Replace with |D - E| degree
#define _SERVO_SPEED       80  // servo speed (degrees per second)
...
{
  // Example conversion equation for Sharp IR sensor
